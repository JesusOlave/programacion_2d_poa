...
namespace UTalDrawSystem.SistemaDibujado
{
    public class Dibujable
    {
        ...
        public Dibujable(string texturaNombre, Vector2 pos, float escala, float rot)
        {
            this.rot = rot;
            this.pos = pos;
            this.escala = escala;
        ...
        {
            SB.Draw(textura, Rotate(((pos)*camaraScale),camaraRot), null, Color.White, camaraRot+rot, centro, camaraScale*escala, SpriteEffects.None, 1);
        }
